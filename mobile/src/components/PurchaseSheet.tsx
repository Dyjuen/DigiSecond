...
export default function PurchaseSheet({ visible, onDismiss, listing, onConfirm }: PurchaseSheetProps) {
                ...
                >
                    ...
                    <ScrollView style={{ maxHeight: 500 }}>
                        <View style={[styles.summaryCard, { backgroundColor: theme.colors.surfaceVariant }]}>
                            <Text variant="titleMedium" numberOfLines={1} style={{ fontWeight: "bold", color: theme.colors.onSurfaceVariant }}>
                                {listing.title}
                            </Text>
