                        ...
                        <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div className="space-y-1">
                                    ...
                                    <div className="font-mono text-sm bg-zinc-100 dark:bg-zinc-800 px-3 py-2 rounded-lg">{user.id}</div>
                                </div>
                                <div className="space-y-1">
                                    <label className="text-xs text-zinc-500 uppercase font-semibold tracking-wider">Role</label>
                                    <div className="font-medium text-zinc-900 dark:text-white px-3 py-2">{user.role}</div>
                                </div>
                                <div className="space-y-1">
                                        ...
                                        <div key={review.review_id} className="p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-xl border border-zinc-200 dark:border-zinc-700">
                                            <div className="flex items-center justify-between mb-2">
                                                ...
                                                <div className="flex items-center gap-1">
                                                    {[...Array(5)].map((_, i) => (
                                                        <svg key={i} className={`w-4 h-4 ${i < review.rating ? "text-amber-400 fill-amber-400" : "text-zinc-300"}`} viewBox="0 0 24 24">
